...
const _DEFAULT_CONFIG = {
    ...
    INTRO_TEXT:       'This is a card sorting game. The goal of the game is to match the card on the bottom with one of the three cards on the top row. Before you begin the game, you will watch a demonstration.',
